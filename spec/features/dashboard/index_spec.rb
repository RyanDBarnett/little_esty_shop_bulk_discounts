...
RSpec.describe 'merchant dashboard' do
  ...
  it 'Then I see a link to view all my discounts that goes to the merchant discounts index page' do
    expect(page).to have_link('View Merchant Discounts', href: merchant_discounts_path(@merchant1.id))
  end
end
